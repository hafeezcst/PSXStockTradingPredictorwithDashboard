...
try:
    ...
    print(f"   GPU available: {stats['system']['gpu_available']}")
...
def main():
    """Main setup function."""
    print("🚀 Enhanced PSX Indicator Processor Setup")
    print("=" * 50)
    ...
    print("2. Run: python enhanced_psx_indicator_processor.py --help")
    print("3. Or run: python usage_examples.py")
    print("\nFor GPU acceleration:")
    print("1. Install CUDA toolkit")
    print("2. pip install cudf-cu11 cupy-cuda11x")
    print("3. Set use_gpu: true in configuration")
